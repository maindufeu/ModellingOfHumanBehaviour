...
LogFare	 = Beta('LogFare',0,-10000,10000,0)
...
LogFare_1  = DefineVariable('LogFare_1',log(Fare_1 ))
LogFare_2  = DefineVariable('LogFare_2',log(Fare_2 ))
LogFare_3  = DefineVariable('LogFare_3',log(Fare_3 ))

# Utilities
Opt1 = Constant1 * one + Fare * Fare_1 + LogFare * LogFare_1 + Legroom * Legroom_1 + SchedDE * Opt1_SchedDelayEarly + SchedDL * Opt1_SchedDelayLate + Total_TT1 * TripTimeHours_1
Opt2 = Constant2 * one + Fare * Fare_2 + LogFare * LogFare_2 + Legroom * Legroom_2 + SchedDE * Opt2_SchedDelayEarly + SchedDL * Opt2_SchedDelayLate + Total_TT2 * TripTimeHours_2
Opt3 = Constant3 * one + Fare * Fare_3 + LogFare * LogFare_3 + Legroom * Legroom_3 + SchedDE * Opt3_SchedDelayEarly + SchedDL * Opt3_SchedDelayLate + Total_TT3 * TripTimeHours_3
