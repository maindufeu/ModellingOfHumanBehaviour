...
#### Elasticicty ####
normalization_car = 1;
elas_car_time = Derive(prob_1,'TimeCar') * TimeCar / prob_1
Agg_Elast_car_Time = elas_car_time * prob_1 / normalization_car


simulate = { 'elas_car_time': Agg_Elast_car_Time, 'probPT' : prob_0, 'probPM': prob_1, 'probSM' : prob_2,'VOT_CAR':VOT_CAR,'VOT_PT':VOT_PT }
