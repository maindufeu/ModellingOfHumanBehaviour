...
################ MODEL 4 ####################
Beta_Cost_inc1 = Beta('Beta_Cost_inc1',0,-10000,10000,0)
Beta_Cost_inc2 = Beta('Beta_Cost_inc2',0,-10000,10000,0)
Beta_Cost_inc3 = Beta('Beta_Cost_inc3',0,-10000,10000,0)
Beta_Cost_inc4 = Beta('Beta_Cost_inc4',0,-10000,10000,0)
...
_Public_T = ASC_PT*one \
            ...
            + Beta_Cost_inc1* PT_cost*inc0_4\
            + Beta_Cost_inc2* PT_cost*inc4_8\
            + Beta_Cost_inc3* PT_cost*inc8_12\
            + Beta_Cost_inc4* PT_cost*inc12_16\
