...
Profession_high = DefineVariable('Profession_high',1*(SocioProfCat<=3))
...
BIOGEME_OBJECT.EXCLUDE = (Choice   ==  -1) + \
                         ((Choice == 1) * (pm_avail != 1) > 0)+ \
                          ...
                          (Profession_high==0)>0         # Exclude answers where individual does not have a profession with high revenu
